...
class ERC20 extends ContractAbstract_1.default {
    ...
    getBalanceOf(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const { contract, decimals } = yield getERC20(token, this.contract.provider);
            const balance = yield contract.balanceOf(this.contract.currAccount);
            return [(0, utils_1.intToFixed)(balance, decimals), balance];
        });
    }
    // 查授权额度 
